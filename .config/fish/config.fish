...
source ~/.config/fish/functions/key-bindings.fish && skim_key_bindings
source ~/.config/fish/functions/home-session.fish
...
status is-interactive; and begin
    ...
    alias ls eza
    alias lt 'eza --tree'
    alias warpstat 'curl https://www.cloudflare.com/cdn-cgi/trace/'

    # Interactive shell initialisation
    source ~/.config/fish/functions/kanagawa.fish
    ...
    begin
        ...
        set fish_complete_path $prev "/home/xaolan/.local/share/fish/home-manager_generated_completions" $post
    end
